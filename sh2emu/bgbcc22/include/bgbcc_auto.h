...
void BGBCC_CCXL_CompileFormJmpTF(BGBCC_TransState *ctx, BCCX_Node *l,char *brt, char *brf);
...
void BGBCC_CCXL_CompileJCO(BGBCC_TransState *ctx, char *op,BCCX_Node *ln, BCCX_Node *rn, char *s);
...
int BGBCC_CCXL_GetRegOprMode1(BGBCC_TransState *ctx, ccxl_register reg);
int BGBCC_CCXL_GetRegOprMode2(BGBCC_TransState *ctx, ccxl_register rega, ccxl_register regb);
int BGBCC_CCXL_GetRegOprMode3(BGBCC_TransState *ctx, ccxl_register dst, ccxl_register rega, ccxl_register regb);
int BGBCC_CCXL_GetRegOprModeW(BGBCC_TransState *ctx, ccxl_register reg, ccxl_type type);
...
int BGBCC_CCXL_GetTypeConvMode(BGBCC_TransState *ctx, ccxl_type dty, ccxl_type sty);
int BGBCC_CCXL_GetTypeConvIMode(BGBCC_TransState *ctx, ccxl_type dty, ccxl_type sty);
int BGBCC_CCXL_GetTypeConvLMode(BGBCC_TransState *ctx, ccxl_type dty, ccxl_type sty);
int BGBCC_CCXL_GetTypeConvILMode(BGBCC_TransState *ctx, ccxl_type dty, ccxl_type sty);
...
int BGBCC_LoadCSourcesFRBC(char **names, int nnames, byte *obuf, int *rsz);
int BGBCC_LoadCSourcesFRBC(char **names, int nnames, byte *obuf, int *rsz);
int BGBCC_GetArch();
