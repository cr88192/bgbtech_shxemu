...
ccxl_status BGBCC_SHX_FlattenImage(BGBCC_TransState *ctx,byte *obuf, int *rosz, fourcc imgfmt);
...
ccxl_status BGBCC_SHX_EndFunction(BGBCC_TransState *ctx,BGBCC_CCXL_LiteralInfo *obj);
...
int BGBCC_SHX_EmitLoadRegImm(BGBCC_SHX_Context *ctx, int nmid, int reg, int imm);
...
int BGBCC_SHXC_EmitGetRegister(BGBCC_TransState *ctx, BGBCC_SHX_Context *sctx, ccxl_register reg);
//AHSRC:mm/inflate.c
int PDUNZ_ReadBit();
int PDUNZ_Read2Bits();
int PDUNZ_Read3Bits();
