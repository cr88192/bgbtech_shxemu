...
ccxl_status BGBCC_CCXL_EmitJumpRegZero(BGBCC_TransState *ctx,ccxl_type ty, int cmpop, ccxl_register reg, ccxl_label lbl);
ccxl_status BGBCC_CCXL_EmitJumpRegCmp(BGBCC_TransState *ctx,ccxl_type ty, int cmpop, ccxl_register sreg, ccxl_register treg, ccxl_label lbl);
...
int BGBCC_CCXL_TryLookupAsRegister(BGBCC_TransState *ctx,char *name, ccxl_register *rreg);
