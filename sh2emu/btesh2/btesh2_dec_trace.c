...
{
	if(!(BTESH2_GetRegDWord(cpu, BTESH2_REG_SR)&BTESH2_SRFL_JQ))
		__debugbreak();

	if(!(BTESH2_GetRegDWord(cpu, BTESH2_REG_SR)&BTESH2_SRFL_DQ))
	{
...
BTESH2_Trace *BTESH2_Trace_Run1(BTESH2_CpuState *cpu, BTESH2_Trace *tr)
{
	...
	ops=tr->ops;
	BTESH2_SetRegQWord(cpu, BTESH2_REG_PC, tr->nxtpc);
	...
	BTESH2_Trace *tr, btesh2_vaddr spc)
{
	...
	if((spc&7)==1)
	{
		i=BTESH2_DecodeTraceVLIW(cpu, tr, spc);
		return(i);
	}
	
	tr->dbgpad1=0x12345678;
	tr->dbgpad2=0x12345678;
	tr->dbgpad3=0x12345678;
	tr->dbgpad4=0x12345678;
	...
	pc=spc; n=0; brapc=0; jmppc=0; nw=0;
...
{
	if(tr->dbgpad1!=0x12345678)
		{ __debugbreak(); }
	if(tr->dbgpad2!=0x12345678)
		{ __debugbreak(); }
	if(tr->dbgpad3!=0x12345678)
		{ __debugbreak(); }
	if(tr->dbgpad4!=0x12345678)
		{ __debugbreak(); }
}

void BTESH2_FlushTrace(BTESH2_CpuState *cpu, BTESH2_Trace *tr)
{
	BTESH2_Trace *tr1, *tr2;
	int i;
	...
	tr1=tr->trnext;		tr2=tr->trjmpnext;
