int BTESH2_DecodeOpcode_BJX1_CC0W(BTESH2_CpuState *cpu, BTESH2_Opcode *op,
	btesh2_vaddr pc, u16 opw, u16 opw2)
{
	...
	return(BTESH2_DecodeOpcode_BJX1_CC0(cpu, op, pc, opw, opw2));
}
